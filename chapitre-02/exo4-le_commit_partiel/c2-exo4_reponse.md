## choisir un fichier modifier et faire un commit partiel 

le fichier **NKBenchRoot** a été copié et collé dans mon **fichier 1** de l'exercice 1

J'ai retiré quelques lignes du code à 2 endroits différents


**Afin de faciliter la lecture, voici les resultats**: 

1. **Resultat du premier commit partiel:
**main e94df42] commit partiel
 1 file changed, 2 insertions(+), 2 deletions(-)**

2. **Resultat du deuxieme commit: voici le resultat: 
[main f98506f] commit partiel
...
J'ai tapé la commande **git add -p.** et voici le résultat :
 
     diff --git a/fichier1 b/fichier1
        index 83f8c21..dd672bf 100644
        --- a/fichier1
        +++ b/fichier1
...
*puis j'ai tapé sur y et voila le resultat:

    @@ -99,13 +99,6 @@ namespace nkentseu {
...
*puis sur n et voici le resultat:


diff --git a/fichier3 b/fichier3
index e69de29..28af025 100644
--- a/fichier3
+++ b/fichier3
@@ -0,0 +1,151 @@
+ 
...
## ensuite j'ai fait le premier commit  

PS C:\Users\GSI\Desktop\INGNE> git commit -m "commit partiel" -m "essai"
[main e94df42] commit partiel
 1 file changed, 2 insertions(+), 2 deletions(-)


 ## jai fait un deuxieme **git add -p.** 
 
 PS C:\Users\GSI\Desktop\INGNE> git add -p.
diff --git a/fichier1 b/fichier1
index 3ea4f02..dd672bf 100644
--- a/fichier1
+++ b/fichier1
@@ -99,13 +99,6 @@ namespace nkentseu {
                return nkbench_detail::RootFoundFlag();
...
<stdin>:155: new blank line at EOF.
+
warning: 3 lines add whitespace errors.


## j ai fait mon deuxieme commit

PS C:\Users\GSI\Desktop\INGNE> git commit -m "commit partiel" -m "essai02"
